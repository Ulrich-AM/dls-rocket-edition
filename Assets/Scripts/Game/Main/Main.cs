...
namespace DLS.Game
{
	public static class Main
	{
		...
		public static readonly Version DLSVersion_ModdedID = new(1, 2, 2);
		public const string LastUpdatedString = "5 May 2025";
		public const string LastUpdatedModdedString = "23 May 2026";
		...
		static Project CreateProject(string projectName)
		{
			ProjectDescription initialDescription = new()
			{
				...
				Prefs_ParallelWires = 0,
				Prefs_ParallelWireSnapThreshold = 0.25f,
				Prefs_ShowAngleIndicator = true,
				Prefs_ShowPerformanceOverlay = false,
