...
namespace DLS.Graphics
{
	public static class PreferencesMenu
	{
		...
		static readonly string[] ParallelWiresOptions = ParallelWireTool.ParallelWiresOptions;
		...
		public static void DrawMenu(Project project)
		{
			...
			using (UI.BeginBoundsScope(true))
			{
				...
				// Draw cancel/confirm/tools buttons
				Vector2 buttonTopLeft = new(labelPosCurr.x, UI.PrevBounds.Bottom);
				int buttonIndex = MenuHelper.DrawButtonTriplet("CANCEL", "CONFIRM", "TOOLS", buttonTopLeft, menuWidth, true);
				...
				{
					UIDrawer.SetActiveMenu(UIDrawer.MenuType.ProjectTools);
				}
			}
