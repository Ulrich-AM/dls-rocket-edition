...
namespace DLS.Description
{
	public static class ChipTypeHelper
	{
		...
		static readonly Dictionary<ChipType, string> Names = new()
		{
			...
			{ ChipType.CustomRom, "CUSTOM ROM" },
			{ ChipType.CustomDisplayRGB, "CUSTOM DISPLAY" },

			// ---- Displays -----
			{ ChipType.DisplayRGB, "RGB DISPLAY" },
			{ ChipType.DisplayRGB8x8, "RGB8x8 (2x2x2)" },
			{ ChipType.DisplayRGBTouch, "TOUCHSCREEN RGB DISPLAY" },
			{ ChipType.DisplayRGB64x64_XY, "RGB64x64 (4x4x4)" },
			{ ChipType.DisplayRGB256x256_XY, "RGB256x256 (4x4x4)" },
			{ ChipType.DisplayRGB64x64_XY_8bit, "RGB64x64 (8x8x8)" },
			{ ChipType.DisplayRGB256x256_XY_8bit, "RGB256x256 (8x8x8)" },
		...
		public static bool IsRomType(ChipType type) => type == ChipType.Rom_256x16 || type == ChipType.BankedRom || type == ChipType.EEPROM_256x16 || type == ChipType.CustomRom;
