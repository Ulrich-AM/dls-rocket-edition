...
namespace DLS.Game
{
	public static class CameraController
	{
		...
		{
			bool placingElementsWithShift = InputHelper.ShiftIsHeld && Project.ActiveProject.controller.IsPlacingElements;
			bool placingWiresWithCtrl = InputHelper.CtrlIsHeld && Project.ActiveProject.controller.IsCreatingWire;
			return !placingElementsWithShift && !placingWiresWithCtrl && InputHelper.IsMouseInGameWindow();
		}
